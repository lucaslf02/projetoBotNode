...
//Pega informações sobre a consulta 

app.post("/retornarConsulta/", (req, res) => {
    const { text } = req.body;
    console.log("id = " + text);
    
    // res.send({mensagem : "resposta obtida"})
    //{url :uri, method: 'POST', json: true, body :text}
    request({url: 'http://localhost:3001/retornarConsulta/' + text, method: 'GET'}, function(request, response, body) {
        let json = JSON.parse(body);
...
//Pega informações sobre o exame 

app.post("/retornarExame/", (req, res) => {
    const { text } = req.body;
    console.log("id = " + text);
    
    // res.send({mensagem : "resposta obtida"})
    //{url :uri, method: 'POST', json: true, body :text}
    request({url: 'http://localhost:3001/retornarExame/' + text, method: 'GET'}, function(request, response, body) {
        let json = JSON.parse(body);
...
//Pega informações sobre as unidades 

app.post("/consultaUnidades", (req, res) => {
    
    
    // res.send({mensagem : "resposta obtida"})
    //{url :uri, method: 'POST', json: true, body :text}
    request({url: 'http://localhost:3001/consultaUnidades', method: 'GET'}, function(request, response, body) {
        let json = JSON.parse(body);
...
//Pega informações sobre as especialidades

app.post("/consultaEspecialidades", (req, res) => {
    
    
    // res.send({mensagem : "resposta obtida"})
    //{url :uri, method: 'POST', json: true, body :text}
    request({url: 'http://localhost:3001/consultaEspecialidades', method: 'GET'}, function(request, response, body) {
        let json = JSON.parse(body);
...
//Pega informações sobre so tipos de exames

app.post("/consultaTipoExame", (req, res) => {
    
    
    // res.send({mensagem : "resposta obtida"})
    //{url :uri, method: 'POST', json: true, body :text}
    request({url: 'http://localhost:3001/consultaTipoExame', method: 'GET'}, function(request, response, body) {
        let json = JSON.parse(body);
